  ...
  switch (action.type) {
    case Actions.SET_SHARK_ATTACKS: {
      ...
      return {
        ...
        data: listing,
        totalDataCount:
          queryTotalResultCount !== null && queryTotalResultCount !== undefined
    ...
    case Actions.SET_RELATED_CASES: {
      return {
        ...state,
        relatedCases: action.payload,
      };
    }
    case Actions.SET_RELATED_CASES_LOADING: {
      return {
        ...state,
        relatedCasesLoading: action.loading,
      };
    }
    default: {
      return state;
