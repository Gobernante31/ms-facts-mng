...
function SharkAttacks() {
  ...
  return (
    <FusePageCarded
      ...
      header={<SharkAttacksHeader pageLayout={pageLayout} />}
      content={<SharkAttacksTable />}
      leftSidebarHeader={<SharkAttacksFilterHeader />}
      leftSidebarContent={<SharkAttacksFilterContent />}
      ref={pageLayout}
      innerScroll
